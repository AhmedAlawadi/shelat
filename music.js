...
let whatsapp = document.getElementsByClassName('whatsapp_musuc');
...
for (let i = 0; i < whatsapp.length; i++) 
{
    whatsapp[i].addEventListener('click', function()
     {
        alert("dfgdfg");
        var text1 = whatsapp[i].parentElement.parentElement.querySelector('p#musicTitle');
        var text2 = text1.innerHTML;
        window.location.href = "https://wa.me/966530117778/?text="+ text2;
    });
}
